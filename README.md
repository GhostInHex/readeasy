...
> This branch is the GatewayHacks 2026 submission (created during Sep 1-Oct 1 window). Primary Track: Accessibility & Health (secondary: Equity in Education).
> ReadEasy as health-literacy + education equity tool. See `HACKATHON_DISCLOSURE.md` and `docs/GATEWAY_TRACK.md`. Demo: [readeasy-gateway.vercel.app](https://readeasy-gateway.vercel.app) (branch deploy: readeasy-git-hackathon-gateway-imvrp555s-projects.vercel.app) | Momen track eligible but built with Next.js+OpenRouter.
